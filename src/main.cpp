...
void setup()
{
    ...
    dht11_1 = new myDHT(nullptr, "/DHT11sens", 12, DHTesp::DHT11, 13000);
    ...
    bm280_1 = new myBM280(nullptr, "/BME280sens1", 4, 5, 0x76, 11000);
    bm280_2 = new myBM280(nullptr, "/BME280sens2", 4, 5, 0x77, 11000);
    ...
    ds18B20 = new myDS18B20(nullptr, "/SD18B20sens", 2, 3000);
    ts2 = new avgSensor(nullptr, "/ErdeTemp", std::list<genSensor *>{ds18B20});

    moisture = new myCapMoisture(nullptr, "/CapSoilMoistsens ", A0, 7000);
